...
const CATEGORIES = {
  scenario:      { label:"Scenario",   color:"#F83564", group:"context" },
  gesture:       { label:"Gesture",    color:"#FFB713", group:"input" },
  control:       { label:"Control",    color:"#F69C40", group:"input" },
  sensor:        { label:"Sensor",     color:"#9B59FF", group:"input" },
  camera:        { label:"Camera",     color:"#43ACE8", group:"input" },
  display:       { label:"Display",    color:"#2D5C9D", group:"output" },
  feedback:      { label:"Feedback",   color:"#00CCC5", group:"output" },
  connect:       { label:"Connect",    color:"#00BF7A", group:"enable" },
  port:          { label:"Port",       color:"#097251", group:"enable" },
  charging:      { label:"Charging",   color:"#FFD600", group:"enable" },
  cooling:       { label:"Cooling",    color:"#5BA0D5", group:"enable" },
  platform:      { label:"Platform",   color:"#D0FF76", group:"enable" },
  physaffordance:{ label:"Affordance", color:"#EF453F", group:"pattern" },
  temporal:      { label:"Temporal",   color:"#7B5CFF", group:"pattern" },
  modality:      { label:"Modality",   color:"#3D8EFF", group:"pattern" },
  material:      { label:"Material",   color:"#F5A623", group:"form" },
  spatial:       { label:"Spatial",    color:"#00A878", group:"form" },
  scale:         { label:"Scale",      color:"#FF6B35", group:"design" },
  learning:      { label:"Learning",   color:"#CC44FF", group:"design" },
  power:         { label:"Power",      color:"#607D8B", group:"design" },
};

const GROUPS = {
  context: { label:"SCENARIO", color:"#F83564" },
  input:   { label:"INPUT",    color:"#FFB713" },
  output:  { label:"OUTPUT",   color:"#2D5C9D" },
  enable:  { label:"ENABLE",   color:"#00BF7A" },
  pattern: { label:"PATTERN",  color:"#EF453F" },
  form:    { label:"FORM",     color:"#F5A623" },
